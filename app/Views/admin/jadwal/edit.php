...
<div class="bg-white rounded-lg shadow p-6">
    <form action="<?= base_url('admin/jadwal/' . $jadwal['id']) ?>" method="POST">
        <?= csrf_field() ?>
        ...
        <div class="mb-4">
            ...
            <select id="id_mata_kuliah" 
                ...
                <?php foreach ($mataKuliah as $mk): ?>
                    <option value="<?= $mk['id_mata_kuliah'] ?>" <?= old('id_mata_kuliah', $jadwal['id_mata_kuliah']) == $mk['id_mata_kuliah'] ? 'selected' : '' ?>>
